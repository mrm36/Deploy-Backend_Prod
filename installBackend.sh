...
echo "Adjusting RabbitMQ .ini..."
	sed -i '2s/.*/BROKER_HOST = 192.168.2.21/g' $HOME/Desktop/GoliathBackendServer/testRabbitMQ.ini
	sed -i '2s/.*/BROKER_HOST = 192.168.2.21/g' $HOME/Desktop/GoliathBackendServer/apiRabbitMQ.ini
